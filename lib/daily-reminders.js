...
const DAILY_NUDGES = [
  ...
  'Gentle nudge: press record today, even if it feels a little messy.',
  'Come as you are — pajamas welcome. Time for today’s recording. 🎥',
  'One small ritual today: record, then log it. That’s the whole practice.',
  'No performance needed — just a few honest minutes with yourself today.',
  'Still time to show up for yourself today. Your recording is waiting. 🌿',
  'Have you had your daily conversation with yourself yet?',
];
