...
const DAILY_NUDGES = [
  ...
  "Your camera's ready when you are. What's stirring today?",
  "No script needed — just a few honest minutes with yourself.",
  "Show up as you are, pajamas and all. Time to record.",
  "A tiny act of courage today: press record.",
  "Your future self will watch this back. Give them something real.",
  ...
  "The hardest part is starting. Press record and see what comes.",
  "What would you say if no one was watching? No one is — record away.",
  "One small recording today. That's how a garden grows.",
  "Your daily check-in is waiting. What's on your heart?",
  "Just you, the camera, and whatever's true today.",
  "Log today's recording and watch yourself grow, one day at a time.",
  "A few unfiltered minutes — that's all today asks.",
];
