...
const PROPAGATION_INTRO =
  ...
  `The Propagation Table is here to challenge you to turn these ideas into 8 different kinds of content. You don't have to do them in order, and you don't have to do them all today. Start wherever feels doable.\n\n` +
  `The only rule is that we will make the first seven creations from what we already have, because I promise that you already have everything you need in your camera roll, your cuttings, and your creative noggin. Blessedly, we don't need to start from scratch because we've already done the hard part. Now, we cultivate it into something we're ready for others to see.\n\n` +
  `Let's get started.`;
...
const PROPAGATION_RUNGS = [
  {
    ...
    emoji: '🎬',
    title: 'BTS Story',
    subtitle: 'The warm-up · disappears in 24h',
    guide:
      `A Story disappears in 24 hours, which is exactly why it's a gentle place to start. Nothing here is permanent, so there's very little to overthink. So with that in mind, here is your first task. Pull a behind-the-scenes moment: you setting up to film, a goofy clip that didn't make the cut, or a photo from your life. Share it.`,
  },
  {
    slug: 'static-post',
    emoji: '🖼️',
