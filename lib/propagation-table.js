...
const PROPAGATION_INTRO =
  ...
  `This challenge is here to help you turn these ideas into 7 different kinds of content. You don't have to do them in order, and you don't have to do them all today. Start wherever feels doable.\n\n` +
...
const PROPAGATION_FINISH =
  `You did it.\n\n` +
  `From a single still image to your own TED talk, look at how much you created with your off-the-cuff ideas. You know how to cultivate your own ideas into shareable content. All of these formats are repeatable and can be used time and time again. Congratulations, dear gardener!`;
