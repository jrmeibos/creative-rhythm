...
const WEEKLY_NUDGES = [
  'It’s a new week — what would you like to tend to over the next few days?',
  'Fresh week, blank page. Set a few intentions to grow toward. 🌱',
  'A gentle start to the week: name what matters most right now.',
  'New week ahead — plant this week’s intentions when you’re ready.',
];
