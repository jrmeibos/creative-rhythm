...
// `takeaway` was merged into `how_it_felt` (Sept 2026) — the column still
// exists (non-destructive, like reflection_text above) but is no longer
// collected or shown. Any old `takeaway` text stops surfacing.
const CUTTING_PROMPTS = [
  { key: 'talked_about', label: 'What did you talk about in today\'s entry?' },
  { key: 'how_it_felt',  label: 'How did it go? Anything you want to remember?' },
];
